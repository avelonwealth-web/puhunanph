...
/**
 * Authenticated: returns Bitly short URL for this user's invite when BITLY_API_TOKEN is set,
 * else the normal long /r/{code} URL. Caches Bitly link on the user doc (same long URL = reuse).
 */
